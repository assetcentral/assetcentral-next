export const PRICING_FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Retained for 90 days. Export anytime.",
  },
  {
  ...
  },
  {
    ...
    a: "You can hold assets in AED, EUR, GBP, USD, CHF, and more. All amounts convert to your base reporting currency automatically. This is separate from your billing currency, which is one of EUR, USD, GBP, or AED.",
  },
  {
    q: "Do you charge VAT?",
    a: "VAT is applied based on your location in accordance with applicable regulations. UAE customers are billed inclusive of 5% VAT.",
  },
  {
  ...
  },
  {
    ...
    a: "Get in touch — Enterprise plans handle unlimited assets and team members, with SSO, custom data residency, dedicated onboarding, and an account manager. Email hello@assetcentral.ai with a sentence about your portfolio and we'll come back to you within 1 business day.",
  },
];
