  ...
  return (
    <>
      ...
      >
        ...
        <p>
          <strong>Holiday lets / short-term rentals.</strong> Operator-dependent, regulation-dependent. The yield numbers from a successful STR are seductive; the failure mode is severe (underperformance, regulatory clampdown, operator going bust). Acquisition test: model the long-term-let scenario as the floor, then add STR as upside. If the property fails on long-term-let economics, the STR premium is gambling.
        </p>
        <p>
