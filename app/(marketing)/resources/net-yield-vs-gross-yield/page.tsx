...
export default function Article() {
  return (
    ...
    >
      ...
      <p>
        <strong>Management and agency fees.</strong> A long-term property manager typically charges 5% of collected rent plus tenant-find fees that average to another 2% annualised. A short-term rental operator charges 20–30%. For a long-let, AED 7,000 is a reasonable annual figure.
      </p>
      <p>
