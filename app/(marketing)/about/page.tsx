  ...
  return (
    <article className="bg-white">
      <div className="mx-auto max-w-3xl px-6 lg:px-10 py-20 lg:py-28">
        ...
        >
          <p>
            Five agents working on your portfolio. <strong>Your CEO</strong> ranks the highest-impact actions to improve yield. <strong>Chief Financial Officer</strong> handles the numbers — real net yield, cashflow, debt, refinance. <strong>Chief Investment Officer</strong> benchmarks rent and tracks comparable transactions. <strong>Chief Operations Officer</strong> watches renewals, statements and cost anomalies. <strong>Personal Assistant</strong> is the concierge — answers questions, organises data, sets alerts. In plain English: an AI agent team that works on your portfolio with you to identify practical actions that can improve yield.
          </p>
          <p>
