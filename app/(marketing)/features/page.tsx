        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 pt-16 lg:pt-24 pb-12">
          <div className="max-w-3xl">
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-sans)" }}
            >
              Five agents — Yield CEO, Finance Agent, Market Analyst, Operations Agent and Portfolio PA — do the things a professional team does inside a property fund, but for private owners and investors with 2 to 50 properties across one or more countries.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[var(--color-surface)]">
        <div className="mx-auto max-w-3xl px-6 lg:px-10 py-20 text-center">
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-sans)" }}
          >
            See your real yield. Let your Yield CEO rank the actions that could improve returns. Free for up to 3 properties — 7-day trial on Pro.
          </p>
          <div className="mt-7">
            <Link
              href="/signup"
