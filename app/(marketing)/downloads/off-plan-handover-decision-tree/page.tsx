...
const DESCRIPTION =
  "Stage payment due, cash tight. Four options, three decision questions, the documents each path requires. Free PDF for landlords with off-plan units approaching handover.";

export const metadata: Metadata = {
  title: `${TITLE} · Free PDF for off-plan landlords | AssetCentral`,
  ...
  return (
    <>
      ...
      <LeadMagnetLayout
        ...
        subtitle="Stage payment due. Cash tight. Four options, three decision questions, and the documents each path requires. Built for landlords with off-plan units approaching handover in 6–12 months."
        ...
        whoFor="Landlords with one or more off-plan units within 12 months of handover, especially if cashflow is tight or the market has softened since purchase."
        pageCount={4}
      />
    </>
  );
